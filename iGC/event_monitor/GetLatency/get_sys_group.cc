...
#define EVT_NUM0 0x02a3
#define EVT_NUM1 0x02a3
#define EVT_NUM2 0x02a3
...
{
	int pid = getpid();
	ofstream outfile("/home/zhao/test/GetEvents.txt");
	...
	do{
		...
		int efd = perf_event_open(&pe_0, -1, sockets[0][2], -1, 0);
		...
		int efd1 = perf_event_open(&pe_1, -1, sockets[0][2], efd, 0);
		...
		int efd2 = perf_event_open(&pe_2, -1, sockets[0][2], efd, 0);
