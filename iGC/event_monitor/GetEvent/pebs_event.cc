...
{
    int ret;
    ret = ioctl(event_file, PERF_EVENT_IOC_ENABLE, PERF_IOC_FLAG_GROUP);
...
{
    int ret;
    ret = ioctl(event_file, PERF_EVENT_IOC_DISABLE, PERF_IOC_FLAG_GROUP);
...
{
    int ret;
    ret = ioctl(event_file, PERF_EVENT_IOC_RESET, PERF_IOC_FLAG_GROUP);
