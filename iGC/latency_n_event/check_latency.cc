...
int S = 1000;			 // allocation size per thread
char ***chunks;
...
void report1(vector<int> efds, ofstream &outfile)
{
	uint64_t values[3];
...
int main(int argc, char *argv[])
{
	...
	ofstream outfile("/home/zhao/test/latency.txt");
	outfile << "event_mean event_stdev chunk_mean chunk_stdev\n";
	char dummy;
